...
privileged aspect UserAccountIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserAccountIntegrationTest.testCountUserAccounts() {
        ...
        long count = pittheo.projects.template.domain.UserAccount.countUserAccounts();
    ...
    public void UserAccountIntegrationTest.testFindUserAccount() {
        pittheo.projects.template.domain.UserAccount obj = dod.getRandomUserAccount();
        ...
        obj = pittheo.projects.template.domain.UserAccount.findUserAccount(id);
    ...
    public void UserAccountIntegrationTest.testFindAllUserAccounts() {
        ...
        java.util.List<pittheo.projects.template.domain.UserAccount> result = pittheo.projects.template.domain.UserAccount.findAllUserAccounts();
    ...
    public void UserAccountIntegrationTest.testFindUserAccountEntries() {
        ...
        java.util.List<pittheo.projects.template.domain.UserAccount> result = pittheo.projects.template.domain.UserAccount.findUserAccountEntries(0, (int) count);
    ...
    public void UserAccountIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUserAccount(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        pittheo.projects.template.domain.UserAccount merged =  obj.merge();
        obj.flush();
    ...
    public void UserAccountIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'UserAccount' failed to initialize correctly", dod.getRandomUserAccount());
        pittheo.projects.template.domain.UserAccount obj = dod.getNewTransientUserAccount(Integer.MAX_VALUE);
    ...
    public void UserAccountIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'UserAccount' with identifier '" + id + "'", pittheo.projects.template.domain.UserAccount.findUserAccount(id));
    }
