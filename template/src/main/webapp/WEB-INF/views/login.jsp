...
<head>
<meta charset="utf-8">
<title>ΓΝΩΣΙΣ - Εκπαίδευση Στελεχών</title>
<meta name="description"
	content="7+ GB of storage, less spam, and mobile access. Gmail is email that's intuitive, efficient, and useful. And maybe even fun.">
<link rel="icon" type="image/ico" href="/stelexi/images/logo-small.ico">
<style type="text/css">
...
::-webkit-scrollbar-track:horizontal:active {
	-webkit-box-shadow: inset 0 1px 0 rgba(0, 0, 0, .14), inset 0 -1px 0
		rgba(0, 0, 0, .07);
...
.jfk-scrollbar-dark::-webkit-scrollbar-track:active {
	background-color: rgba(255, 255, 255, .1);
	-webkit-box-shadow: inset 1px 0 0 rgba(255, 255, 255, .25), inset -1px 0
...
.jfk-scrollbar-dark::-webkit-scrollbar-track:horizontal:active {
	-webkit-box-shadow: inset 0 1px 0 rgba(255, 255, 255, .25), inset 0 -1px
		0 rgba(255, 255, 255, .15);
...
::-webkit-scrollbar-thumb:horizontal {
	border-width: 7px 0 0;
	padding: 0 0 0 100px;
	-webkit-box-shadow: inset 1px 1px 0 rgba(0, 0, 0, .1), inset -1px 0 0
		rgba(0, 0, 0, .07);
...
.jfk-scrollbar-dark::-webkit-scrollbar-thumb {
	...
	-webkit-box-shadow: inset 1px 1px 0 rgba(255, 255, 255, .15), inset 0
...
.jfk-scrollbar-dark::-webkit-scrollbar-thumb:horizontal {
	-webkit-box-shadow: inset 1px 1px 0 rgba(255, 255, 255, .15), inset -1px
...
.jfk-scrollbar-borderless::-webkit-scrollbar-track:hover {
	...
	-webkit-box-shadow: inset 1px 1px 0 rgba(0, 0, 0, .14), inset -1px -1px
		0 rgba(0, 0, 0, .07);
...
.signin-box h2 strong {
	...
	width: 52px;
	background: transparent
		url(//ssl.gstatic.com/accounts/ui/google-signin-flat.png) no-repeat;
}
	...
	<div class="wrapper">
		<div class="google-header-bar">
			...
			<a href="" title="" style="text-decoration: none;">
				<img id="globe" src="/stelexi/images/logo-667017.png" style="position:absolute; left: 40px; top: -5px;" width="80" height="75" alt="">
			</a>
				<c:if test="${not empty loggedUser and loggedUser.canWrite}">
					<span class="signup-button">Δεν είστε χρήστης; 
						<a id="link-signup" class="g-button g-button-red"
						href="/stelexi/signup?form">Δημιουργηστε λογαριασμο</a>
					</span>
				</c:if>
			</div>
		</div>
		...
		<div class="errorblock">
			...
			${message}
				<div class="signin-box">
					...
					<form id="gaia_loginform" action="/stelexi/login" method="post">
						<label> 
						<strong class="email-label">Username</strong> 
							<input type="text" name="username" id="username" value="">
						</label> 
						<label> <strong class="passwd-label">Password</strong> <input
							type="password" name="password" id="password" value="">
						</label> <input type="submit" class="g-button g-button-submit"
							name="signIn" id="signIn" value="Sign in">
					</form>
					<ul>
						<li></li>
					</ul>
		...
		<div class="google-footer-bar">
			<div class="footer content clearfix">
				<ul>
					<li id="year-copyright">© Γνώσις</li>
				</ul>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	var d = new Date();
	var el = document.getElementById("year-copyright");
	el.innerHTML = "© " + d.getFullYear() + " App Template";
</script>
